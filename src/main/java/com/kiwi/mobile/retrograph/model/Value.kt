...
/**
 * Class representing argument value.
 */
 ...
 *
 * @param TParent [Argument] or [Value].
 */
class ObjectValue<TParent>(
  val parent: TParent,
  name: String = ""
):
  Value<MutableList<Value<*>>>(name, mutableListOf()) {
  ...
  fun valuesOf(instance: Any): ObjectValue<TParent> =
    apply {
